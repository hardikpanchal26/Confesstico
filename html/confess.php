   ...
   <!-- Header** -->
    ...
    <td width="50%" valign="top">
        ...
        <div class="box">   
            ...
            <p class="box-h">"Confess</p>

                <p align="center">
                    <b>Confess here.You will remain anonymous.<br />Nobody will ever know, who did the Confession.</b><br />
                    Do confession and free yourself. You can confess about your college life, personal life, about someone else, be it your crush or troll someone!
                </p>
            <hr style="margin:0"/>
            <form name="confessform" action="#" method="post">
                <input type="text" name="groups" placeholder="Confess under Groups" style="width:256px; height:25px" />
                <input type="text" name="ctg" placeholder="Tag Categories" style="width:256px; height:25px" />
                <p style="padding-left:10px;">
                    <b>Write your Confession here.</b><br /><br />
                    Add an Image : <input type="file" value="Add Image" />
                </p>
                <textarea name="text" style="height:150px; width:530px" placeholder="Say whatever you want to say without any fear..."></textarea>
                <input type="submit"  value="I Confess" class="btn" onclick="javascript : return confession_v()"/>
            </form>

   ...
   <!-- Header** -->
    ...
    <td width="50%" valign="top">
        ...
        <div class="box">   
            ...
            <p class="box-h">"My Profile</p>
            <div class="box">
                <form action="#" method="post">
                    <table width="100%">
                        <tr>
                            <td width="50%" align="center"><img src="../images/profile_pic.png" alt="profile_pic" class="img-profile">
                            </td>
                            <td>
                                <?php
                                echo '<p style="padding-left:10px; font-size:14px">Unique User ID :
                                    <input type="text" value="UID0' . $row['id'] . '" style="margin:1px"/>
                                </p>';
                                echo '
                                <p style="padding-left:10px; font-size:14px">Mobile :
                                    <input type="text" value="' . $row['mob'] .'" style="margin:1px"/>
                                </p>';
                                echo '<p style="padding-left:10px; font-size:14px">Unique User ID :
                                    <input type="text" value="' . $row['email'] . '" style="margin:1px"/>
                                </p>';
                                ?>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <?php
                                echo'
                                <p style="padding-left:10px; font-size:14px">First Name :
                                    <input type="text" value="' . $row['fn'] . '" style="margin:1px"/>
                                </p>';
                                ?>
                            </td>
                            <td>
                                <?php
                                echo '
                                <p style="padding-left:10px; font-size:14px">Surname :
                                    <input type="text" value="' . $row['sn'] . '" style="margin:1px"/>
                                </p>';
                                ?>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <?php
                                echo '
                                <p style="padding-left:10px; font-size:14px">Birthday :
                                    <input type="date" value="' . $row['bday'] . '" style="margin:1px"/>
                                </p>';
                                ?>
                            </td>
                            <td>
                                <?php
                                echo '
                                <p style="padding-left:10px; font-size:14px">Location :
                                    <input type="text" value="' . $row['loc'] . '" style="margin:1px"/>
                                </p>';
                                ?>
                            </td>
                        </tr>
